function update_open(d, r, old_merged_cluster)
    ...
    for i in 1:rows
        ...
        if sum(r) == size(d)[1]
            ...
            d_close, left_c, right_c = update_close_m(d, r, i, cl_posNsize)
    ...
    merged_clusters = shrink_clusters(cl_posNsize, new_cl_posNsize)
